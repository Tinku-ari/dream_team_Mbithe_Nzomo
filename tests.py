...
class TestViews(TestBase):
    ...
    def test_logout_view(self):
        """
        Test that logout view is inaccessible without login
        and redirects to the login page then to logout
        """
    ...
    def test_departments_view(self):
        """
        Test that the departments page is inaccessible without login
        and redirects to login page then to the departments page
        """
    ...
    def test_roles_view(self):
        ...
        and redirects to the login page then to the roles page
        """
    ...
    def test_employees_view(self):
        ...
        and redirect to login page then to the Employees page
        """
...
class TestErrorPages(TestBase):
    ...
    def test_500_internal_server_error(self):
        # create route to abort the request with the internal server Error
        @self.app.route('/500')
